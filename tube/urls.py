...
from .views import principal, historial, favorito, contactanos, contra, crear, reproductor, listado, lista_categoria, guardar_video, eliminar_video, modificar, modificar_video, login_view, logout_view, form_login
